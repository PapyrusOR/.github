...
#### 2. 模式配置
**Agent模式**: AI将使用工具调用进行卡片的添加，编辑，删除等操作  
**Chat模式**: 仅保留聊天功能
...
- **开发模式**: 本人为主，AI辅助(Claude Sonnet 4.6, Gemini 3.0 Pro)
...
[报告问题](https://github.com/Alpaca233114514/Papyrus/issues) · [功能请求](https://github.com/Alpaca233114514/Papyrus/issues) · [下载发布](https://github.com/Alpaca233114514/Papyrus/releases)
